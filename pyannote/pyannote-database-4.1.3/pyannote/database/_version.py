...
def get_keywords():
    ...
    # get_keywords().
    git_refnames = " (tag: 4.1.3, master)"
    git_full = "701fdd2667d5bddeeda5df88584af086c2f8397b"
...
def get_config():
    ...
    cfg.style = "pep440"
    cfg.tag_prefix = ""
    cfg.parentdir_prefix = "pyannote-database-"
    cfg.versionfile_source = "pyannote/database/_version.py"
    cfg.verbose = False
    return cfg
